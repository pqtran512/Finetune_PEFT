...
def main():
    ...
    OUTPUT_DIR = "./models/java-qwen/stage_2_v4"
    ...
    # Drop overlong samples — truncating the target tail removes EOS and trains the model never to stop.
